...
be mapped onto a [VC707 FPGA Evaluation Kit](https://www.xilinx.com/products/boards-and-kits/ek-v7-vc707-g.html).
...
Next, read the section corresponding to the VC707 kit for
instructions on how to use this repo.

Software Requirement
--------------------

To compile the bootloaders for Freedom U500 VC707
FPGA dev kit, the RISC-V software toolchain must be installed locally and
